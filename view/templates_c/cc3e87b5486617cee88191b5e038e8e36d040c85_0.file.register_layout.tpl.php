<?php
/* Smarty version 3.1.29, created on 2016-05-28 01:23:20
  from "/var/www/html/Notbook/view/templates/register_layout.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5749395872aa27_06963726',
  'file_dependency' => 
  array (
...
function content_5749395872aa27_06963726 ($_smarty_tpl) {
?>
<div class="row">
    <form class="col s12">
        <div class="row">
            <div class="input-field col s6">
                ...
                <input placeholder="María" id="first_name" type="text" class="validate">
                <label for="first_name">Nombre(s)</label>
            </div>
            <div class="input-field col s6">
                <input placeholder="Perez" id="last_name" type="text" class="validate">
        ...
        <div class="row">
            ...
            <div class="input-field col s6">
                <input id="password_ver" type="password" class="validate">
